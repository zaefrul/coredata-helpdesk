                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" id="model" name="model" value="{{old('model', $inventory->model)}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <select class="js-select" data-search="true" id="type" data-placeholder="Select a option.." name="type">
                                                    @foreach ($component_types as $type)
                                                        <option value="{{ $type->value }}" {{ old('type', $inventory->type) == $type->value ? 'selected' : '' }}>{{ $type->label }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>        
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" id="sn" name="serial_number" value="{{ old('serial_numbner', $inventory->serial_number) }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" id="pn" name="part_number" value="{{ old('part_number', $inventory->part_number) }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" id="mfg_part_number" name="mfg_part_number" value="{{ old('mfg_part_number', $inventory->mfg_part_number) }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
