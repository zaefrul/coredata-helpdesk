                                ...
                                <table class="table table-middle mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="tb-col">
                                                <div class="media-group">
                                                    <div class="media media-md flex-shrink-0 media-middle media-circle text-bg-success">
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="card-title-group">
                                    ...
                                    <div class="card-tools">
                                        <em class="icon-hint icon ni ni-help-fill" data-bs-toggle="tooltip" data-bs-placement="left" title="Sessions from device"></em>
                                    </div>
                                </div><!-- .card-title-group -->
                                            ...
                                            <li class="nk-timeline-item">
                                                <div class="nk-timeline-item-inner">
                                                    ...
                                                    <div class="nk-timeline-content">
                                                        <p class="small"><strong>Nick Mark</strong> mentioned <strong>Sara Smith</strong> in a new post</p>
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="nk-timeline-item">
                                                <div class="nk-timeline-item-inner">
                                                    ...
                                                    <div class="nk-timeline-content">
                                                        <p class="small">The post <strong>Post Name</strong> was removed by <strong>Nick Mark</strong></p>
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="nk-timeline-item">
                                                <div class="nk-timeline-item-inner">
                                                    ...
                                                    <div class="nk-timeline-content">
                                                        <p class="small"><strong>Patrick Sullivan</strong> published a new <strong>post</strong> </p>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="nk-timeline-list">
                                            <li class="nk-timeline-item">
                                                <div class="nk-timeline-item-inner">
                                                    ...
                                                    <div class="nk-timeline-content">
                                                        <p class="small"><strong>240+</strong> users have subscribed to Newsletter #1 </p>
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="nk-timeline-item">
                                                <div class="nk-timeline-item-inner">
                                                    ...
                                                    <div class="nk-timeline-content">
                                                        <p class="small">The post <strong>Post Name</strong> was suspended by <strong>Nick Mark</strong> </p>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="card-title-group">
                                    ...
                                    <div class="card-tools">
                                        <em class="icon-hint icon ni ni-help-fill" data-bs-toggle="tooltip" data-bs-placement="left" title="Web Sessions from region"></em>
                                    </div>
                                </div><!-- .card-title-group -->
